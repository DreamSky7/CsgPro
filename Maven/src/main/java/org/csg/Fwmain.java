...
import org.csg.sproom.Listener.TemporaryWorldListener;
...
public class Fwmain extends JavaPlugin implements Listener {
	...
	public static TemporaryWorldManager temporaryWorldManager;
	...
	public void onEnable() {
		...
		// 初始化临时世界管理器
		temporaryWorldManager = new TemporaryWorldManager(this);
		...
		try{
			...
			// 启动信息
			MessageUtils.ConsoleInfoMsg("插件启动成功！ [CsgPlusPro " + version + " ]");
	...
	public void onDisable() {
		...
		MessageUtils.ConsoleInfoMsg("正在退出所有玩家");
	...
	private void LeaveServerListen(PlayerQuitEvent evt){
		...
		MessageUtils.ConsoleInfoMsg("玩家"+evt.getPlayer()+"因离开游戏而离开队列。");
	}
