...
public class TaskExecuter implements CycleUpdate {
    ...
    public List<UUID> getField(){
        if(begin.getField() == null || StringUtils.isBlank(begin.getField())){
            ...
            while(mch.find()){
                ...
                if(value instanceof String[]){
                    ...
                    try{
                        ...
                        MessageUtils.ConsoleErrorMsg(String.format("解析变量 %s 时出现了数组越界！", String.format("$%s$", s)));
                    }
    ...
    public void onUpdate() {
        ...
        if(next!=null){
            try{
                ...
                next = null;
                MessageUtils.ConsoleErrorMsg("在运行任务时出现错误！");
                e.printStackTrace();
            }
        }else{
